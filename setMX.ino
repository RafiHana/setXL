...
//  /* Serial device defines for dxl bus */
 ...
 #define NEW_ID 13 //NewID to be changed.
...
//   Dxl.writeWord(NEW_ID, Goal_Postion_Address, 1000);
   // Wait for 1 second (1000 milliseconds)
   delay(1000);
   /*Turn dynamixel to position 300 by new id*/
//   Dxl.writeWord(NEW_ID, Goal_Postion_Address, 3400);
   Dxl.writeWord(NEW_ID, Goal_Postion_Address, 2047);
   // Wait for 1 second (1000 milliseconds)
   delay(1000);
 }
